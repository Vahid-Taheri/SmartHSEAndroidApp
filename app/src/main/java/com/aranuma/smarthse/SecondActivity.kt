...
class SecondActivity : AppCompatActivity() {
    ...
    private lateinit var setUserBtn:Button
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setUserBtn = findViewById(R.id.set_user)
        ...
        syncTimeBtn.setOnClickListener{
            ...
            batteryTextView.text = sdk.battery.getString("result")
        }
        ...
        setUserBtn.setOnClickListener{
            try {
                sdk.write("4D53473A4172610D0A".toByteArray(Charsets.US_ASCII))
